...
.method private static a([Landroid/util/Size;DD)Landroid/graphics/Rect;
    ...
    const-string v13, "Camera2: FrameSize "
    ...
    invoke-static {v11, v7}, Lcom/unity3d/player/g;->Log(ILjava/lang/String;)V
...
.method private a(Ljava/lang/Object;)V
    ...
    const-string p1, "Camera2: Focus completed."
    ...
    const-string p1, "Camera2: Focus canceled."
...
.method public final a(Landroid/content/Context;IIIII)Z
    ...
    :try_start_0
    sget-object v5, Lcom/unity3d/player/a;->b:Landroid/hardware/camera2/CameraManager;
    ...
    const-string v7, "Camera2: Hardware level: "
    ...
    invoke-static {v7, v6}, Lcom/unity3d/player/g;->Log(ILjava/lang/String;)V
    ...
    invoke-static {v9, v0}, Lcom/unity3d/player/g;->Log(ILjava/lang/String;)V

    return v4

    :cond_0
    invoke-static {v5}, Lcom/unity3d/player/a;->a(Landroid/hardware/camera2/CameraCharacteristics;)[Landroid/util/Size;
    ...
    invoke-static {v6, v10, v11, v12, v13}, Lcom/unity3d/player/a;->a([Landroid/util/Size;DD)Landroid/graphics/Rect;

    move-result-object v6

    iput-object v6, v1, Lcom/unity3d/player/a;->h:Landroid/graphics/Rect;
    ...
    :cond_2
    invoke-static {v6, v0}, Lcom/unity3d/player/a;->a([Landroid/util/Range;I)I

    move-result v6

    new-instance v8, Ljava/lang/StringBuilder;

    const-string v10, "Camera2: FPS requested: "
    ...
    invoke-static {v7, v0}, Lcom/unity3d/player/g;->Log(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v7, v6}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V

    iput-object v0, v1, Lcom/unity3d/player/a;->q:Landroid/util/Range;
    ...
    invoke-virtual {v0, v7, v8, v6}, Ljava/util/concurrent/Semaphore;->tryAcquire(JLjava/util/concurrent/TimeUnit;)Z
    ...
    iget-object v10, v1, Lcom/unity3d/player/a;->B:Landroid/hardware/camera2/CameraDevice$StateCallback;

    iget-object v11, v1, Lcom/unity3d/player/a;->g:Landroid/os/Handler;

    invoke-virtual {v0, v6, v10, v11}, Landroid/hardware/camera2/CameraManager;->openCamera(Ljava/lang/String;Landroid/hardware/camera2/CameraDevice$StateCallback;Landroid/os/Handler;)V
    :try_end_2
    ...
    invoke-virtual {v0, v7, v8, v2}, Ljava/util/concurrent/Semaphore;->tryAcquire(JLjava/util/concurrent/TimeUnit;)Z
    ...
    const-string v6, "Camera2: Interrupted while waiting to open camera "
    ...
    iput v2, v1, Lcom/unity3d/player/a;->w:I

    invoke-direct {p0, v5}, Lcom/unity3d/player/a;->b(Landroid/hardware/camera2/CameraCharacteristics;)V

    iget-object v0, v1, Lcom/unity3d/player/a;->d:Landroid/hardware/camera2/CameraDevice;
    ...
    const-string v5, "Camera2: Interrupted while trying to lock camera for opening "
...
.method public final d()V
    ...
    const-string v0, "Camera2: Pause preview."
...
.method public final e()V
    ...
    const-string v0, "Camera2: Stop preview."
